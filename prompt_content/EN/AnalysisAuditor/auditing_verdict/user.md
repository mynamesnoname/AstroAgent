...
{% if discussion_QSO %}
#### QSO Discussion (per-hypothesis critique ↔ patch response)
...
{% if discussion_ELG %}
#### ELG Discussion (per-hypothesis critique ↔ patch response)
...
{% if discussion_LRG %}
#### LRG Discussion (per-hypothesis critique ↔ patch response)
